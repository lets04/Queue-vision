# Respaldo de vision_detector.py
# Este archivo es una copia de seguridad de `vision_detector.py` antes de eliminar el duplicado.
# Si necesitas restaurarlo, copia este archivo a la raíz del proyecto.
...
# ZONA DE FILA (personalizable por cámara)
...
# TRACKER SIMPLE (solo para este segmento)
...
while True:
    ...
    for idx, persona in enumerate(personas_ordenadas):
        ...
        #  Mostrar posición local en segmento
        cv2.putText(img, f"S{segmento}-{num_local}", (centro[0]-25, centro[1]-15),
